                            ...
                            <div className="dropdown dropdown-end">
                                <div tabIndex={0} role="button" className="btn btn-ghost btn-circle">
                                    <div className="indicator">
                                        ...
                                        <span className="badge badge-sm indicator-item">{cart ? cart.items.length : 0}</span>
                                    </div>
                                </div>
                                <div
                                    tabIndex={0}
                                    ...
                                    <div className="card-body">
                                        <span className="text-lg font-bold">{cart ? cart.items.length : 0} Items</span>
                                        <span className="text-info">Subtotal: &#8377; {cart ? cart.totalPrice : 0}</span>
